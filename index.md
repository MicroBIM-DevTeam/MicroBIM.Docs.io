...
[![Download Now](https://img.shields.io/badge/Download-v1.4.0-blue?style=for-the-badge&logo=nuget&logoColor=white)](downloads/MicroBIM.Revit.Template.1.4.0.nupkg)
...
```bash
dotnet new install MicroBIM.Revit.Template.1.4.0.nupkg
```
